          ...
          <fieldset className="flex flex-col gap-3 border-0 p-0">
            ...
            <div className="grid grid-cols-7 gap-2">
              {MASTERY_OPTIONS.map((option) => (
                <label
                  key={option ?? BEGINNER}
                  className="cursor-pointer rounded-md border border-slate-700 px-1 py-2 text-center text-sm has-checked:border-slate-100 sm:px-4 has-checked:bg-slate-100 has-checked:text-slate-900"
                >
                  <input
                    type="radio"
                    name="level"
